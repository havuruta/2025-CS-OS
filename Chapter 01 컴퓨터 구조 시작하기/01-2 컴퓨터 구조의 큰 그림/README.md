...
### Q20. 메모리를 보조하는 특별한 기능을 수행하는 입출력장치의 부품으로 옳지 않은 것은?
...
### Q22. 컴퓨터가 빠르게 작동하기 위해서는 메모리 속 명령어와 데이터의 위치가 정돈되어 있어야 하는데, 메모리에 저장된 값을 빠르고 효율적으로 접근하기 위해 사용하는 개념의 용어는?
